...
if(isset($_POST['sub'])){
    ...
    $opfolder = "opimg/" . $filename;
          ...
          $sql = "INSERT INTO advjava (title, descr, code, op, opexp) VALUES ('$name', '$desc', 'opimg/$opfilename','codeimg/$filename','$opexp')";
...
<body>
    ...
    <div class="main">
        <div class="glass">
            ...
            <form enctype="multipart/form-data"  action="addAdvConcept.php" method="post" class="form">
